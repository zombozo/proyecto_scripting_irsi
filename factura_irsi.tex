...
\hline
Nombre completo & {Vizcaya} \\
Correo electrónico & {+34 723 657 032} \\
Teléfono & {117.149.232.25} \\
Dirección & {cmedina@example.org} \\
Ciudad & {cmedina@example.org} \\
\end{tabularx}
...
\hline
Cantidad comprada & {completo} \\
Monto total & ₡{completo} \\
T1702.04o de exitoso & {exitoso} \\
Estado del exitoso & {estado_exitoso} \\
IP de compra & {1702.04} \\
Fecha y hora & {} \\
\end{tabularx}
